        ...
        <div id="wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php 
                                        ...
                                        }else $count_all_user=0;
                                    ?>
                                    <div class="huge"><?php echo $count_all_user; ?></div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php 
                                        $sql = "SELECT count(username) as count FROM users where status='DEACTIVE'";
                                        $res = mysqli_query($con,$sql);

                                        if($res->num_rows > 0){
                                            while ($row = $res->fetch_array(MYSQL_BOTH)){
                                                $count_user_deactive = $row['count'];
                                            }
                                        }else $count_user_deactive=0;
                                    ?>
                                    <div class="huge"><?php echo $count_user_deactive; ?></div>
                                    <div>สมาชิกที่รอยืนยัน</div>
                                </div>
                            </div>
                        </div>
                        <a href="all_user_deactive.php">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php 
                                        $sql = "SELECT count(username) as count FROM users where status='ACTIVE'";
                                        $res = mysqli_query($con,$sql);

                                        if($res->num_rows > 0){
                                            while ($row = $res->fetch_array(MYSQL_BOTH)){
                                                $count_user_active = $row['count'];
                                            }
                                        }else $count_user_active=0;
                                    ?>
                                    <div class="huge"><?php echo $count_user_active; ?></div>
                                    <div>สมาชิกที่ยืนยันแล้ว</div>
                                </div>
                            </div>
                        </div>
                        <a href="all_user_active.php">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php 
                                        $sql = "SELECT count(username) as count FROM admin";
                                        $res = mysqli_query($con,$sql);
                                    ...
                                    ?>
                                    <div class="huge"><?php echo $count_admin; ?></div>
                                    <div>เจ้าหน้าที่</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i> เหตุการณ์</h3>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-info-circle fa-fw"></i> Log</h3>
                        </div>
                        <div class="panel-body">
