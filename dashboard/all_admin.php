            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="reservations.php"><i class="fa fa-fw fa-user-secret"></i> ปิด-เปิด ระบบจองคิว</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> เจ้าหน้าที่ 
                                </li>
                            </ol>
                            <!-- Show Data in table -->
                            <?php
                            if($_SESSION['Admin_Piority'] == 'OFFICER'){
                                echo "
                                ...
                                <div class='row'>
                                    <div class='col-lg-12'>
                                        <div class='alert alert-info alert-dismissable'>
                                            ...
                                            <i class='fa fa-info-circle'></i>  <strong>สถานะของคุณ</strong> สามารถดูข้อมูลเจ้าหน้าที่ได้เฉพาะระดับเดียวกันหรือต่ำกว่า
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-hover table-bordered results">
                              <thead>
                                ...
                                <tr class="warning no-result">
                                    <td colspan="11" style="text-align:center;"><i class="fa fa-warning"></i> ไม่พบข้อมูล</td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                if($_SESSION["Admin_Piority"] == "ADMIN"){
                                    $sql = "SELECT * FROM admin";
                                }else{
                                    $sql = "SELECT * FROM admin WHERE piority='OFFICER'";
                                }
