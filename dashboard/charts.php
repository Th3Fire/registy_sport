            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="all_user.php"><i class="fa fa-fw fa-file"></i> สมาชิกทั้งหมด</a>
                        </li>

                        <li>
                            <a href="all_user_deactive.php"><i class="fa fa-fw fa-file"></i> สมาชิกที่รอยืนยัน</a>
                        </li>

                        <li>
                            <a href="all_user_active.php"><i class="fa fa-fw fa-file"></i> สมาชิกที่ยืนยันแล้ว</a>
                        </li>

                        <li>
                            <a href="all_admin.php"><i class="fa fa-fw fa-file"></i> เจ้าหน้าที่</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
